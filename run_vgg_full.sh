...
run_vgg_iris_gender(){
    ...
    for i in $(seq 1 30); do  # CHANGE NUMBERS APPROPRIATELY
        ...
        # done
        python ./vgg_full.py -d 0 -p $i -e $2 --use_peri -bs $1 -o second_both_peri_vgg_results -lr 0.0005
        python ./vgg_full.py -d 0 -p $i -e $2 --use_val --use_peri -bs $1 -o second_both_peri_vgg_results_val -lr 0.0005
    done
