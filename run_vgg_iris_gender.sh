...
run_vgg_iris_gender(){
    ...
    for i in $(seq 1 5); do
        ...
        python ./vgg_iris_gender.py -d $d -p $i -e $2 --use_peri -bs $1 -o initial_both_peri_vgg_results -lr 0.0005
        python ./vgg_iris_gender.py -d $d -p $i -e $2 --use_val --use_peri -bs $1 -o initial_both_peri_vgg_results_val -lr 0.0005
    done
